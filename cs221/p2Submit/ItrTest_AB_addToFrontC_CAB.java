	 ...
	 * @author CS221
	 */
	public class ItrTest_AB_addToFrontC_CAB 
	{
		 ...
		 * Expected Result: Reference to second element in list
		 */
		@Test
		...
		/**
		 * Test: new Iterator, call next() three times; test hasNext() - whether there's a next element in the Iterator list
		...
		/**
		 * Test: new Iterator, call next() three times; test next() - tries to return ref to next element in the Iterator list
		...
		/**
		 * Test: new Iterator, call next() three times; test remove() - removes last element returned by next in the Iterator list
		 * Expected Result: No exception
		 */
		@Test 
		...
		/**
		 * Test: new Iterator, call next() three times, remove(); test hasNext() - whether there's a next element in the Iterator list
		 * Expected Result: false
		 */
		@Test
		...
		/**
		 * Test: new Iterator, call next() three times, remove(); test next() - tries to return ref to next element in the Iterator list
		 * Expected Result: Reference to last element in list
		 */
		@Test(expectedExceptions = NoSuchElementException.class) 
		...
		/**
		 * Test: new Iterator, call next() three times, remove(); test remove() - tries to remove last element returned by next in the Iterator list
		 * Expected Result: IllegalStateException
		 */
		@Test(expectedExceptions = IllegalStateException.class) 
		...
		/**
		 * Test: new Iterator, call next() twice, remove(), next(); test hasNext() - whether there's a next element in the Iterator list
		 * Expected Result: false
		 */
		@Test
		...
		/**
		 * Test: new Iterator, call next() twice, remove(), next(); test next() - tries to return ref to next element in the Iterator list
		 * Expected Result: Reference to last element in list
		 */
		@Test(expectedExceptions = NoSuchElementException.class) 
		...
		/**
		 * Test: new Iterator, call next() twice, remove(), next(); test remove() - removes last element returned by next in the Iterator list
		 * Expected Result: No exception
		 */
		@Test
