 ...
 * Tests for Change Scenario 19: [A, B] -> remove(0) -> [B]
 * 
 * @author Matt T
 */
public class Test_AB_remove0_B
{
	...
	{
		// create empty list - state of list before change scenario
	 ...
	 */
	   ...
	   /**
	    * Data: Two indexes: -1 and index 1 past last element in the list. 
	    * 
	    * @return 2D array (second dimension empty) indexes of list
