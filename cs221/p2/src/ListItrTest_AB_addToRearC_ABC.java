	 ...
	 * @author Matt T 
	 */
	public class ListItrTest_AB_addToRearC_ABC {
		 ...
		 * Expected Result: Reference to element B in list
		 */
		@Test 
		 ...
		 * Expected Result: Reference to element A in list
		 */
		@Test 
		 ...
		 * Expected Result: Reference to the last element in the list
		 */
		@Test
		 ...
		 * Expected Result: Reference to the first element in the list
		 */
		@Test
		...
		/**
		 * Test: new ListIterator, call next() twice and previous(); test previous() - returns ref to previous element in the ListIterator list
		 * Expected Result: Reference to element B in the list
		 */
		@Test
		public void testListItrNextNextNextPrev_previous()
		{
			itr = TestCase.initListItr(list, TestCase.ListItrState.nextNextNextPrev);
			TestCase.previous(itr, TestCase.B); 
		}
