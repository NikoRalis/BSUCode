	 ...
	 * List Iterator Tests for Change Scenario 2. [ ] -> addToFront(A) -> [A] 
	 * 
	 * @author Matt T 
	 */
	public class ListItrTest_emptyList_addToFrontA_A {
		...
		* Expected Result: NoSuchElementException
		 ...
		 * Expected Result: Reference to last element in the list
		 */
		@Test 
